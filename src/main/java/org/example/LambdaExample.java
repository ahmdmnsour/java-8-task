...
public class LambdaExample {
    ...
    public static void main(final String[] args) {
        ...
        Predicate<User> ageOlderThanFivePredicate = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.age > 5;
            }
        ...
        repository.select(ageOlderThanFivePredicate, nameComparator);
        ...
        // DONE With functional interfaces declared
        Predicate<User> ageYoungerThanTenPredicate = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.age < 10;
            }
        ...
        repository.select(ageYoungerThanTenPredicate, ageComparator);
        ...
        // DONE With functional interfaces declared
        Predicate<User> ageOlderThanEightPredicate = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.age > 8;
            }
        };
        repository.select(ageOlderThanEightPredicate, nameComparator);
